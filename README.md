...
课程基于C/Python/数据结构等课程知识，涵盖封装/继承/多态等基本面向对象设计思想，基于`Java 25`学习讨论：

- Functional Programming/Optional/Stream API/Date-Time API/Files/Virtual Threads等基础技术知识
- 以及，Structured Task Scope结构化并发/NIO Selector多路复用/NIO SocketChannel异步非阻塞网络编程/Flow反应式编程等技术知识
